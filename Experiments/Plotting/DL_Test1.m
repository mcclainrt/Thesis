...
try
    figure
    hold on
    plot(Data.Ex2.Filtered.V1.Test1.Tag_7(:,1),Data.Ex2.Filtered.V1.Test1.Tag_7(:,6),'*','DisplayName','AFM-1 Detections Ambient')
...
try
    figure
    hold on
    plot(Data.Ex2.Smoothed.V1.Test1.Tag_7(:,1),Data.Ex2.Smoothed.V1.Test1.Tag_7(:,6),'*','DisplayName','AFM-1 Detections Ambient')
