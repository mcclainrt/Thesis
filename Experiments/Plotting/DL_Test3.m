...
try
    figure
    hold on
    plot(Data.Ex2.Filtered.V1.Test3.Tag_7(:,1),180-abs(Data.Ex2.Filtered.V1.Test3.Tag_7(:,7)),'*','DisplayName','AFM-1 Detections Ambient')
...
try
    figure
    hold on
    plot(Data.Ex2.Smoothed.V1.Test3.Tag_7(:,1),180-abs(Data.Ex2.Smoothed.V1.Test3.Tag_7(:,7)),'*','DisplayName','AFM-1 Detections Ambient')
