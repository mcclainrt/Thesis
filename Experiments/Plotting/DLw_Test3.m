...
try
    figure
    hold on
    plot(Data.Ex5.Filtered.V1.Test3.Tag_7(:,1),180-abs(Data.Ex5.Filtered.V1.Test3.Tag_7(:,7)),'*','DisplayName','AFM-1 Detections Ambient')
...
try
    figure
    hold on
    plot(Data.Ex5.Smoothed.V1.Test3.Tag_7(:,1),180-abs(Data.Ex5.Smoothed.V1.Test3.Tag_7(:,7)),'*','DisplayName','AFM-1 Detections Ambient')
