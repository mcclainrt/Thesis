...
% Ex4.P.T1 = struct('1',0,'1.5',0,'2',0,'2.5',0);
Ex4.T = struct('T1',zeros(1,8),'T2',zeros(1,8),'T3',zeros(1,8),'T4',zeros(1,8));
%Ex4.V1 = struct('T1',0,'T2',0,'T3',0,'T4',0);
    ...
    if strcmp('.bag',Fext)
        ...
        switch Namecell{2}
            case 'P'
                switch Namecell{3}
                    case '1'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.P.T1);
                        Ex4.P.T1 = cat(1,Ex4.P.T1,loaded);
                        if Ex4.P.T1(1)==0 % is there an easier way to do this?
                            Ex4.P.T1(1,:)=[];
                        end
                    case '2'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.P.T2);
                        Ex4.P.T2 = cat(1,Ex4.P.T2,loaded);
                    case '3'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.P.T3);
                        Ex4.P.T3 = cat(1,Ex4.P.T3,loaded);
                    case '4'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.P.T4);
                        Ex4.P.T4 = cat(1,Ex4.P.T4,loaded);
                end
            case 'T'
                switch Namecell{3}
                    case '1'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.T.T1);
                        Ex4.T.T1 = cat(1,Ex4.T.T1,loaded);
                    case '2'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.T.T2);
                        Ex4.T.T2 = cat(1,Ex4.T.T2,loaded);
                    case '3'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.T.T3);
                        Ex4.T.T3 = cat(1,Ex4.T.T3,loaded);
                    case '4'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.T.T4);
                        Ex4.T.T4 = cat(1,Ex4.T.T4,loaded);
                end
            case 'V1'
                switch Namecell{3}
                    case '1'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V1.T1);
                        Ex4.V1.T1 = cat(1,Ex4.V1.T1,loaded);
                    case '2'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V1.T2);
                        Ex4.V1.T2 = cat(1,Ex4.V1.T2,loaded);
                    case '3'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V1.T3);
                        Ex4.V1.T3 = cat(1,Ex4.V1.T3,loaded);
                    case '4'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V1.T4);
                        Ex4.V1.T4 = cat(1,Ex4.V1.T4,loaded);
                end
            case 'V2'
                switch Namecell{3}
                    case '1'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V2.T1);
                        Ex4.V2.T1 = cat(1,Ex4.V2.T1,loaded);
                    case '2'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V2.T2);
                        Ex4.V2.T2 = cat(1,Ex4.V2.T2,loaded);
                    case '3'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V2.T3);
                        Ex4.V2.T3 = cat(1,Ex4.V2.T3,loaded);
                    case '4'
                        loaded = loadbagmsgs(msgs,Fname,Ex4.V2.T4);
